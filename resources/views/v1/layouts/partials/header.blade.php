<header class="main-header">
    <a href="{{ url(__prefix()) }}" class="logo">
        <span class="logo-mini">{{ substr(__app_name(), 0,1) }}</span>
        <span class="logo-lg">{{ __app_name() }}</span>
    </a>
                        ...
                        <li>
                            <ul class="menu">
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="https://via.placeholder.com/350x350" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                        Support Team
